...
= 1.1.4 =
* Add a new exchange. ([OKEx](https://www.okex.com/))
* Add support for GBP as base currency for [Bitstamp](https://www.bitstamp.net/).

= 1.1.3 =
* Add support for the new [X-addresses](https://xrpaddress.info/).
...
= 1.1.4 =
Another exchange ([OKEx](https://www.okex.com/)) has been added and [Bitstamp](https://www.bitstamp.net/) now supports GBP as a base currency.
